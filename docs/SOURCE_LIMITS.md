...
Use this policy whenever a skill cleans, summarizes, triages, searches, rewrites, or structures user material.

## Source access level

State the source access level before making factual or evidence-sensitive claims:
...
- Treat unpublished writing, private notes, meeting material, transcripts, sensitive documents, and nonpublic packets as confidential.
- Use external tools with search terms, public identifiers, citations, or short non-sensitive summaries when that is enough.
